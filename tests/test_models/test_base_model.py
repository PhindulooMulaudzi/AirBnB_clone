...
class BaseModel_testing(unittest.TestCase):
    ...
    def testpep8(self):
        ...
        rest = pepstylecode.checking_files(['models/base_model.py',
                                            'models/__init__.py',
...
class test_for_base_model(unittest.TestCase):
    ...
    def test_str(self):
        ...
        dictonary = {'id': 'cc9909cf-a909-9b90-9999-999fd99ca9a9',
                     ...
                     '__class__': 'BaseModel',
                     'updated_at': '2026-06-28T14:00:00.000001',
                     'score': 80
                     }
    ...
    def test_BaseModel(self):
        """ checking attributes values in a BaseModel """
